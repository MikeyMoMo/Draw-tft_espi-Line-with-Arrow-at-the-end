...
#define doBackLine true
#define noBackLine false
#define doTriangleFill true
#define noTriangleFill false
/***************************************************************************/
void setup()
/***************************************************************************/
{
...
/***************************************************************************/
{
  ...
  //       winglets.
  tft.fillScreen(TFT_BLACK);
  drawArrowLine(&tft, 50, 50, 200, 120, TFT_RED, 12, PI / 6, TFT_WHITE,
                true, true);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_GREEN, 12, PI / 6, TFT_WHITE, true, true);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_BLUE, 12, PI / 6, TFT_YELLOW, false, true);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_RED, 12, PI / 6, TFT_WHITE, true, true);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_PURPLE, 12, PI / 6, TFT_YELLOW, false, true);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_RED, 12, PI / 6, TFT_WHITE, true, true);
  ...
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_GREEN, 12, PI / 6, TFT_WHITE, true, false);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_BLUE, 12, PI / 6, TFT_YELLOW, false, false);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_RED, 12, PI / 6, TFT_WHITE, true, false);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_PURPLE, 12, PI / 6, TFT_YELLOW, false, false);
  drawArrowLine(&tft, random(tft.width()), random(tft.height()),
                random(tft.width()), random(tft.height()),
                TFT_RED, 12, PI / 6, TFT_WHITE, true, false);
  delay(10000);
  ...
  drawArrowLine(&mySprite, 50, 50, 200, 120, TFT_RED, 12, PI / 6, TFT_WHITE,
                true, true);
